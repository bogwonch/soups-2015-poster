...
Users decide which apps to use based on their own preferences as well as security and privacy policies. % DA: overloading "policies" is confusing, do you mean Android policies here?
...
In a user study of XX Android users,  %% RIGHT?
...
Other categories classify PUPs (potentially unwanted programs) % Let's use McAfee term, not Google
...
%% HOW MANY ARE?  SHOULD GIVE SOME NUMBER FOR e.g.
% We found XX out of 60,000 had >80% compliance.
...
policies. % AppPAL can filter apps on the basis of these policies.
...
\item We do not have the full user purchase history, and we can only
  ...
  databases.  % unmask a subset of installed apps.
